    ...
    <div>
      <section className="body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-white rounded-lg shadow-2xl">
            <svg
...
{/*               Edison bulb retro cloud bread echo park, helvetica stumptown
            ...
            <span className="inline-block h-1 w-10 rounded bg-[#F4E9CD] mt-8 mb-6"></span>
